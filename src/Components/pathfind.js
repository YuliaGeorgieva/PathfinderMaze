...
import "./Pathfind.css";
import dijkstra from "../Algorithms/MazeAlgorithms/dijkstras.js";
import Rmaze from "../Algorithms/PathAlgorithms/PrimsAlgorithms.js";
...
const Pathfind = () => {
  ...
  return (
    ...
    <div className="header">
      <p>
        Create your own walls and move the nodes. Try it out and have fun!
      </p>
    </div>
    <div className="button-container">
      <div className="button-row">
        <button className="btn visualize-btn" onClick={visualizePath}>
          Path (A*)
        </button>
        <button className="btn random-btn" onClick={randomWalls}>
          Random Walls
        </button>
        <button className="btn reset-btn" onClick={Reset}>
          Reset
        </button>
        <button className="btn maze-btn" onClick={generateMaze}>
